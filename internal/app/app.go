...
func Swaggerize(swag *swagger.SwaggerModel, routes []swaggerizer.SwaggerizeRoute) {
...
func parseResponses(responses []swaggerizer.SwaggerizeResponse) (map[string]swagger.SwaggerPathResponse, []swaggerizeResponseDefinition) {
